...
#'https://www.tripadvisor.com/Attraction_Review-g1898350-d7726549-Reviews-Lomma_Hamn-Lomma_Skane_County.html',
#'https://www.tripadvisor.com/Attraction_Review-g189838-d10134259-Reviews-Skrylle_Nature_reserve-Lund_Skane_County.html'
            ]
...
for file_name in file_names:
    ...
    for url in url_list:
        if file_name[0:-5] in url:
            res_name = file_name[0 : file_name.find('_Skane_County')-5]
