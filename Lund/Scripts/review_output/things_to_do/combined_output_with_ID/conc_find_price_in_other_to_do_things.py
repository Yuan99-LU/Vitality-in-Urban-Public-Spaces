...
data1 = pd.read_csv('Lund_to_do_things_overview.csv', names = ['name','url','review count',
                                                               'aggregating rating value', 'price range','address',
                                                               'postcode', 'category'])
...
#print(data2['total review count'])
...
data2.to_csv('./' + 'things_to_do_in_Lund_add_address_etc' +'.csv', mode = 'w', index= False)
