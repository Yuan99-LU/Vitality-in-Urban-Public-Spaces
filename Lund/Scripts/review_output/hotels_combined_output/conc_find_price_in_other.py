...
data1 = pd.read_csv('restaurant_overview_Lund.csv')

data2= pd.read_csv('all_184_restaurants_in_Lund.csv',
...
data2.to_csv('./' + 'all_184_restaurants_in_Lund_add_price_address_etc' +'.csv', mode = 'w', index= False)
