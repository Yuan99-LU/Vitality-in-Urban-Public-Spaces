...
def main_one_attraction(URL_LUND, FILE_PATH):
    ...
    for i in range(11, int(N_all_lang)):
        url  = URL_LUND
        driver.get(url)
...
if __name__ == "__main__":
    ...
    URL_LUND_Group = ['https://www.tripadvisor.com/Attraction_Review-g189838-d319374-Reviews-Botanical_Gardens_Botaniska_Tradgarden-Lund_Skane_County.html',
    ...
    for URL_LUND in URL_LUND_Group[0:]:
        ...
        FILE_PATH = PATH + PLACE + '-ID-' + CITY_ID + "complete_languages.csv"
